...
#I'd like to add hyperlinked text
```{r}
...
```{r}
osp_results |> html_elements('li') |> html_text() #showing the raw html
```
...
```{r}
releases <- osp_results |> html_elements('li') |> html_text() |> as_tibble() #showing only text
